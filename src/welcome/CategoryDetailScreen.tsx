...
const CategoryDetailScreen = () => {
    ...
    const renderQuestionItem = ({
        ...
        const isLearning =
            mastery?.level && mastery.level !== MasteryLevel.NEW && !isMastered;
        ...
        >
            ...
            <View style={styles.content}>
                ...
                <FormattedText
                    ...
                    numberOfLines={4}
                >
                    Les icônes suivent votre maîtrise lorsque vous vous évaluez
                    sur les cartes (bouton ci-dessus ou onglet Entraînement).
                    Touchez une ligne pour lire la réponse sans noter.
                </FormattedText>
