...
export const AdvancedSearchPanel: React.FC<AdvancedSearchPanelProps> = ({
    ...
    const handleSearchScopeChange = (
        scope: "question" | "explanation" | "both"
    ) => {
        if (scope === "both") {
            ...
            onFilterChange({
                ...
                searchIn: filters.searchIn.includes("both")
                    ...
                    : filters.searchIn.includes(scope)
                      ...
                      : [
                            ...filters.searchIn.filter((s) => s !== "both"),
                            scope,
                        ],
            });
        }
        ...
        >
                        ...
                        >
                            <FormattedText
                                style={[
                                    ...
                                    {
                                        color: filters.categories.includes(
                                            category.id
                                        )
            ...
            <View style={styles.filterSection}>
                ...
                <View style={styles.scopeButtons}>
                    {(["question", "explanation", "both"] as const).map(
                        (scope) => (
                            <TouchableOpacity
                                key={scope}
                                style={[
                            ...
                            >
                                <FormattedText
                                    style={[
                                        ...
                                        {
                                            color: filters.searchIn.includes(
                                                scope
                                            )
                                                ? theme.colors.buttonText
                                                : theme.colors.text,
