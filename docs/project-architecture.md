...
A comprehensive React Native mobile application built with Expo for studying
French citizenship questions. The app features customizable themes, interactive
testing functionality, flash card study mode, advanced search capabilities, and
detailed progress tracking.

## Overview

This is a cross-platform mobile application that helps users prepare for French
nationality/citizenship tests. It provides:
...
- Context Providers: All global state managed through React Context with proper provider hierarchy
- Type Safety: Comprehensive TypeScript coverage with strict type checking
- Modular Design: Separated concerns with clear file organization
- Platform Optimization: Conditional rendering for mobile/web
- Performance: Lazy loading, optimized rendering, and caching strategies
- Error Handling: Comprehensive error handling with logging
- Data Caching: Intelligent caching with TTL and retry logic
